...
RSpec.describe "Api::V1::Sellers", type: :request do
  ...
  describe "POST /create" do
    context 'with correct parameters' do
      ...
      before do
        post '/api/v1/sellers', params: { seller: attributes_for(:seller)}
      end 
    ...
    context 'with incorrect parameters' do
      ...
      before do
        ...
        post '/api/v1/sellers', params: { seller: incorrect_params}
      end 
  ...
  describe "PATCH /update" do
    context 'with correct parameters' do
      ...
      before do
        ...
        patch "/api/v1/sellers/#{seller.id}", params: { seller: updated_params}
      end 
      ...
      it 'updates the record' do
        expect(seller.reload.firstname).to eq('updated_firstname')
      end
    end
  end
